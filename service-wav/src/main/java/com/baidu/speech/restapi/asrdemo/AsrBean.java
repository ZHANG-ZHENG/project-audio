...
public class AsrBean {
    ...
    private final String APP_KEY = "pFCnEi950wbE3TYx0E2mQqMp";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "s5anO2MTzMNGhzHyTDqCaotEogct0mYx";
    ...
    */
    ...
    public String run(MultipartFile mFile) throws IOException, DemoException {
        ...
        if (METHOD_RAW) {
            ...
            result = runJsonPostMethod(token,mFile);
        }
        return result;
    }
    ...
    public String runJsonPostMethod(String token,MultipartFile mFile) throws DemoException, IOException {
